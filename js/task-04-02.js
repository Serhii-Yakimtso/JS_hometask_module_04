...
//     index и arr.Функция возвращает true или false в зависимости от того встречается ли элемент первый раз
...
// [1, 2, 3, 4, 5]
console.log("right answer is [1, 2, 3, 4, 5]");
console.log("");
console.log("");
console.log("");
...
// [2, 4, 2]
console.log("right answer is [2, 4, 2]");
